...
#pragma message("NVFBC_GLOBAL_FLAGS_STEREO_BUFFER flag will be deprecated, and will not be available from next release.")
/**
* \ingroup NVFBC
* Indicates to NVFBC that stereo rendering is enabled. Currently unsupported. To be used with NVFBC_SetGlobalFlags API.
* This flag will be deprecated, and will not be available from next release.
*/
...
/**
* \ingroup NVFBC
* For compatiblity with applications developed using Nvidia Capture SDK 6.0.
*/
#define bSupport16x16DiffMap bSupportConfigurableDiffMap
...
typedef struct _NvFBCStatusEx
{
    ...
    NvU32  bSupportConfigurableDiffMap  : 1;  /**< [out] 16x16, 32x32, 64x64 and 128x128 difference map supported. */

...
#define NVFBC_MAX_DIFF_MAP_SIZE 0x00040000

/**
* \ingroup NVFBC_TODX9VID
* \brief For compatiblity with applications developed using Nvidia Capture SDK 6.0.
*/
#define b16x16DiffMap eDiffMapBlockSize                               

#define NVFBC_MAX_16x16_DIFF_MAP_SIZE NVFBC_MAX_DIFF_MAP_SIZE
/**
...
typedef struct
{
    ...
    NvU32 eDiffMapBlockSize :3;                 /**< [in]: Valid only if bDiffMap is set. Set this bit field using NVFBC_DX9VID_DIFFMAP_BLOCKSIZE enum. Default is 128x128 Diffmap.*/
    NvU32 bReservedBits     :24;                /**< [in]: Reserved. Set to 0.*/
    ...
    NvU32 dwDiffMapBuffSize;                    /**< [in]: Size of diffMap buffer allocated by client. Client must use NVFBC_MAX_DIFF_MAP_SIZE for 128x128 and NVFBC_MAX_16x16_DIFF_MAP_SIZE for 16x16 Diffmap .*/

...
typedef struct
{
    ...
    NvU32 eDiffMapBlockSize :3;              /**< [in]: Valid only if bDiffMap is set. Set this bit field using enum NVFBC_TOSYS_DIFFMAP_BLOCKSIZE. Default blocksize is 128x128*/
    NvU32 bReservedBits     :25;             /**< [in]: Reserved. Set to 0.*/
